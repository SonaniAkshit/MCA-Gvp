//Write a Java program that contains two arrays of two dimensions that hold data of
//matrix and perform matrix operation like addition, subtraction, and multiplication etc.

import java.util.Scanner;

class p5matrixoperation {
